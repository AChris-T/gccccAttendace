...
const AdminAttendanceFilter = ({
    ...
    return (
        <Animated
            animation="fade-up"
            className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow animate-fadeIn w-full lg:w-1/2 xl:w-1/2 transition-all duration-300"
        >
            {/* Filter Fields */}
            <div className="p-6">
