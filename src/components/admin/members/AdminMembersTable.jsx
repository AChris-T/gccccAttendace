...
const AdminMembersTable = () => {
  ...
  const tableHeight = useMemo(() => {
    ...
    const contentHeight =
      memberData.length * ROW_HEIGHT + HEADER_HEIGHT + PAGINATION_HEIGHT;
    return Math.min(
  ...
  const LinkRenderer = useCallback(({ value }) => {
    ...
    return (
      <Link
        ...
        className="text-blue-600 underline transition-colors dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
              ...
              <div className="flex items-center justify-between mt-4 text-sm text-gray-500 dark:text-gray-400">
                ...
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full dark:bg-green-400 animate-pulse"></span>
