...
export const LegacyInlineCalculator = ({ event, onBack }) => {
        ...
        <div>
          ...
          {saved && registrationData && (
            <div className="p-6 bg-white sm:p-8 dark:bg-slate-800">
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tr className="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                      ...
                      <td className="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                        ...
                        {registrationData.nights !== 1 ? 's' : ''} × ₦7,000
                      </td>
              ...
              <div className="p-4 mt-6 bg-slate-50 dark:bg-slate-900/50 rounded-xl">
                <div className="text-xs text-slate-600 dark:text-slate-400">
                  ...
                  <p>
                    ...
                    {new Date(registrationData.timestamp).toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
