...
const FollowupDetails = ({ firstTimerData }) => {
    return (
        <SectionCard title="Follow-up Details" icon={UserCheckIcon} isEdit={false}>
            <InfoField icon={CalendarIcon} label="Assigned At" value={formatDate(firstTimerData.assigned_at)} />
            <InfoField icon={UserCheckIcon} label="Assigned To" value={firstTimerData.assigned_to_member?.full_name} />
