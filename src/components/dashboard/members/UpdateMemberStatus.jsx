...
const UpdateMemberStatus = ({ memberData, onClose }) => {
    ...
    }, [updateMember, memberData.id, isStatusActive, onClose]);
    ...
    return (
        <div className="w-full max-w-lg mx-auto">
            ...
            <div className="flex items-start gap-4 mb-6">
                <div className={`shrink-0 w-12 h-12 rounded-full flex items-center justify-center ${isStatusActive
            ...
            <div className={`p-4 rounded-lg border mb-6 ${isStatusActive
                ...
                <div className="flex gap-3">
                    <AlertTriangleIcon className={`w-5 h-5 shrink-0 mt-0.5 ${isStatusActive
                    ...
                    <div className="flex-1">
                        <p className={`text-sm leading-relaxed ${isStatusActive
                            ...
                            <span className="font-medium">{memberData?.first_name}'s</span> record will be{' '}
