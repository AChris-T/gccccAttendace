  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50">
        <div className="mx-auto max-w-7xl px-0 sm:px-3 lg:px-8">
          <div
            className={`md:mt-3  z-9999 relative flex justify-between md:rounded-2xl md:border border-white/10 px-3 py-2 backdrop-blur-xl transition-colors ${
          ...
          >
            <div className="flex flex-col mt-2 w-full justify-between ">
              <div className=" flex flex-col gap-2">
                ...
                <div className="flex md:hidden items-center gap-2 text-sm text-white">
                  <span className="font-medium tabular-nums">
                    {formattedTime}
                  </span>
                  <span className="text-white/40">|</span>
