export const DeleteConfirmation = ({ name, isSuccess }) => (
  <div className="w-full">
    ...
    {isSuccess && (
      <div className="p-4 mb-5 duration-300 border border-green-200 rounded-lg bg-green-50 dark:bg-green-900/10 dark:border-green-900/30 animate-in fade-in slide-in-from-top-2">
