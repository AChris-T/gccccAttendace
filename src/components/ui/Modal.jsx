...
// Mock Animated component for demo
const Animated = ({ children, animation, className, onClick, ...props }) => (
  <div className={className} onClick={onClick} ref={props.ref}>
    {children}
  </div>
);
...
const Modal = ({
  ...
  const handleBackdropClick = useCallback(
    (e) => {
      // Only close if clicking directly on the backdrop (not on modal or its children)
