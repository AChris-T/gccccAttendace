    ...
    <div className="relative w-full p-4 overflow-y-auto bg-white rounded-3xl dark:bg-gray-900 lg:p-11">
      <div className="px-2">
        <div className="flex items-center gap-3 mb-3">
          <div
            className={`flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${roleConfig.bgClass}`}
          >
            <EditIcon width={24} className="text-white" fill="currentColor" />
          </div>
          <div>
            <h4 className="text-2xl font-semibold text-gray-900 dark:text-white">Edit Social Media</h4>
          </div>
        </div>
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7 pl-0.5">
          Update your social media links to stay connected.
        </p>
      </div>
